...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-info">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search" action="search_product.php" method="get"><!-- search_product.php -->
                ...
                <?php 
                    if(isset($_SESSION['username'])){
                        echo "
                            ...
                            <li class='nav-item'>    <a href='users_area/user_login.php' class='nav-link text-light'>Logout</a>    </li>
                        ";
                    }else{
                        echo "
    ...
    <!-- Last-child -->
    <div class="bg-info footer d-flex align-center justify-content-center">    <p class="text-light text-center">All right reserved @- Designed by Ahmed Hossam</p>    </div>
