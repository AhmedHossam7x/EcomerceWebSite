...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">    <a class="nav-link" href="displayAll.php">Proudct</a>    </li>
                    ...
                    <form class="d-flex" role="search">
                        ...
                        <input class="btn btn-outline-light" type="submit" alue="Search" name="Search">
                    </form>
                </div>
            </div>
        </nav>
    ...
    <!-- Last-child -->
    <div class="bg-info p-1">    <p class="bg-info text-light text-center p-2">All right reserved @- Designed by Ahmed Hossam</p>    </div>
